...
// 演示用 sample 数据 —— 仅 Xcode Preview / DEBUG 构建可用。
// release build 由 `#if DEBUG` 完全排除，不让 "Lily's MacBook"、"192.168.1.42" 等
// 假名 / 假 IP 出现在 binary 字符串里。runtime 数据全部走 ShareEngine + EngineProjection。

# MeshDrop · windows 端 UI 完整开发 Prompt（自动拼接）

> 这份 prompt 由 prompts/feed.sh 拼接 COMMON.md + 04-windows.md + TESTING_AND_ACCEPTANCE.md 生成。
> 复制整段给 AI，它将拥有从零做出 windows 端 UI 的全部信息。
